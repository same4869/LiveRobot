...
import com.xun.liverobot.manager.Connection;
import com.xun.liverobot.manager.MqttManager;
import com.xun.liverobot.mvp.model.bean.Subscription;
...
public class ActionListener implements IMqttActionListener {
    ...
    private void connect() {
        ...
        try {
            ...
            LogUtil.e(TAG, "Failed to Auto-Subscribe: " + ex.getMessage());
        } catch (Exception e) {
            LogUtil.e(TAG, "connect exception:" + (e == null ? "null" : e.getMessage()));
        }
